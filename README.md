...
* Download the code in ZIP format or just clone the <a href="https://github.com/UOC-SA-SPRING-2024/spring-2024-productcatalog-improved">spring-2024-productcatalog-improved</a>, <a href="https://github.com/UOC-SA-SPRING-2024/spring-2024-user-improved">spring-2024-user-improved</a> and <a href="https://github.com/UOC-SA-SPRING-2024/spring-2024-notification-improved">spring-2024-notification-improved</a> repositories into the working folder (_spring-2024_ if the recommendation has been followed)
